...
def prepare_seediv_features(root_dir, out_path, time_steps=10, stride=1, session=1, input_type='lds_de', num_channels=62, num_bands=5):
    ...
    labels = SEEDIV_LABELS_BY_SESSION[int(session)-1]
